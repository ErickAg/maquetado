				...
				<table class="table">
					...
					<tbody>
						...
						foreach ($servicios as $key => $value) {
							?>
							<tr>
								<td><?php echo $value['suc_ser'] ?></td>
								<td><?php echo $value['exp_ser'] ?></td>
								<td><?php echo $value['cl_ser'] ?></td>
								<td><?php echo $value['emp_ser'] ?></td>
								<td>
									<a href="#">Editar</a>
									<a href="#" class="eliminar" data-id="<?php echo $value['id_ser'] ?>">Eliminar</a>
								</td>
							</tr>
							<?php
						}
		...
		function listar(){
			...
			$.post( "includes/_funciones.php",objeto, function(data) {
				...
				datos.forEach(function(e){
					construyeFila(e.suc_ser, e.exp_ser, e.cl_ser, e.id_usr);
				})
			});
		}
		function construyeFila(sucursales, experiencia, clientes, id){
			let html = `
			<tr>
			<td>${sucursales}</td>
			<td>${experiencia}</td>
